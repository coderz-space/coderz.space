...
export default function Sidebar() {
  ...
  return (
    <aside className="sticky top-0 flex h-screen w-60 flex-col border-r border-purple-200 bg-gray-100 px-4 py-6 transition-colors dark:border-purple-900 dark:bg-gray-950">
      <div className="mb-8 px-2">
        <span className="text-lg font-bold tracking-wide text-purple-400">Algo Buddy</span>
        <p className="mt-1 text-xs text-gray-500 dark:text-gray-500">Mentor Dashboard</p>
      </div>
